...
print(json.dumps(attempts), file=sys.stderr)
print(json.dumps({"ok": True, "output": "Hallo (" + str(sum(v.startswith('blocked') for v in attempts.values())) + "/" + str(len(attempts)) + " exfiltration attempts blocked)"}))
